...
namespace GmailAPI.APIHelper
{
    public static class GmailAPIHelper
    {
        ...
        public static GmailService GetService()
        {
            ...
            using (FileStream stream = new FileStream(Convert.ToString("C:/GmailAPI/ClientCredentials/client_secret.json"), 
                FileMode.Open, FileAccess.Read))
            {
                String FolderPath = Convert.ToString("C:/GmailAPI/CredentialsInfo");
